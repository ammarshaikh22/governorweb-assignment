            ...
            <div className='max-w-[90%] mx-auto'>
                <div className='flex md:flex-row flex-col justify-between items-center'>
                    <div className='md:w-[50%] relative z-50 text-center md:text-start'>
                        ...
                        <div className="relative z-50  md:mt-4 flex gap-4 md:gap-20 flex-col md:flex-row">
                    ...
                    <div className='md:w-[50%] mt-6 md:mt-0'>
                        <Image src='/governor.png' alt='governor' width={900} height={900} className="min-w-[900px] -left-40 absolute md:top-4 md:-right-[420px] " />
                    </div>
                </div>
            </div>
        </section>
